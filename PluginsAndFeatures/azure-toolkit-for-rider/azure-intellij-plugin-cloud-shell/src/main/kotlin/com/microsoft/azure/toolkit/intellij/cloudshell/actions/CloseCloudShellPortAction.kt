...
class CloseCloudShellPortAction(private val port: Int) : AnAction(port.toString()) {
    ...
    override fun actionPerformed(e: AnActionEvent) {
        ...
        currentThreadCoroutineScope().launch {
            withBackgroundProgress(project, "Closing preview port $port in Azure Cloud Shell...") {
