...
public class CognitiveAccountPlaygroundProvider implements FileEditorProvider, DumbAware {
    public static final String COGNITIVE_ACCOUNT_PLAYGROUND_TYPE = "Microsoft.CognitiveServices.accounts";
    ...
    @AzureOperation(name = "user/openai.open_playground.account", params = {"virtualFile.getName()"})
    public FileEditor createEditor(@Nonnull Project project, @Nonnull VirtualFile virtualFile) {
        final CognitiveAccount account = (CognitiveAccount) virtualFile.getUserData(AzureResourceEditorViewManager.AZURE_RESOURCE_KEY);
        assert account != null;
    ...
    public String getEditorTypeId() {
        return COGNITIVE_ACCOUNT_PLAYGROUND_TYPE;
    }
