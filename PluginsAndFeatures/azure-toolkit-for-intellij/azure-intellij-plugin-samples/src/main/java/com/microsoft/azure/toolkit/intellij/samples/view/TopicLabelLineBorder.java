...
public class TopicLabelLineBorder extends RoundedLineBorder {
    public TopicLabelLineBorder(Color color) {
        super(color);
    }

    public TopicLabelLineBorder(Color color, int thickness) {
