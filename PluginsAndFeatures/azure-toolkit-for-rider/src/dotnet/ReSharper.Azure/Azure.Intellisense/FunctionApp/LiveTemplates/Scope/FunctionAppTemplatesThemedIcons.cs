...
namespace JetBrains.UI.ThemedIcons
{
	...
	///	<para>To use an icon from XAML, set an <see cref="System.Windows.Media.ImageSource"></see> property to the <see cref="System.CodeDom.CodeTypeReference"></see> markup extension, which takes an icon identifier class (nested in <see cref="FunctionAppTemplatesThemedIcons"></see> class) as a parameter.</para>
	///	<para>Example:</para>
	///	<code>&lt;Image Source="{icons:ThemedIcon myres:DodofuxThemedIconsThemedIcons+Trinity}" /&gt;</code>
	///	<h1>Attributes</h1>
	///	<para>Sometimes you have to reference an icon from a type attriute when you're defining objects in code. Typical examples are Options pages and Tool Windows.</para>
	///	<para>To avoid the use of string IDs which are not validated very well, we've emitted identifier classes to be used with <c>typeof()</c> expression, one per each icon. Use the attribute overload which takes a <see cref="System.Type"></see> for an image, and choose your icon class from nested classes in the <see cref="FunctionAppTemplatesThemedIcons"></see> class.</para>
	///	<para>Example:</para>
	///	<code>[Item(Name="Sample", Icon=typeof(DodofuxThemedIconsThemedIcons.Trinity))]</code>
	///	<h1>CodeBehind</h1>
	///	<para>In codebehind, we have two distinct tasks: (a) specify some icon in the APIs and (b) render icon images onscreen.</para>
	///	<para>On the APIs stage you should only manipulate icon identifier objects (of type <see cref="JetBrains.UI.Icons.IconId"></see>, statically defined in <see cref="FunctionAppTemplatesThemedIcons"></see> in <c>Id</c> fields). Icon identifier classes (nested in <see cref="FunctionAppTemplatesThemedIcons"></see>) should be turned into icon identifier objects as early as possible. Rendering is about getting an <see cref="System.Windows.Media.ImageSource"></see> to assign to WPF, or <see cref="System.Drawing.Bitmap"></see> to use with GDI+ / Windows Forms.</para>
	...
	///</remarks>
	public sealed class FunctionAppTemplatesThemedIcons
	{
		#region AzureFunctionsTrigger
		
		[global::JetBrains.Application.Icons.CompiledIconsCs.CompiledIconCsAttribute()]
		public sealed class AzureFunctionsTrigger : global::JetBrains.Application.Icons.CompiledIconsCs.CompiledIconCsClass
		{

			/// <inheritdoc cref="AzureFunctionsTrigger">identifier class</inheritdoc>
			public static global::JetBrains.UI.Icons.IconId Id = new global::JetBrains.Application.Icons.CompiledIconsCs.CompiledIconCsId(typeof(AzureFunctionsTrigger));

			/// <summary>Loads the image for Themed Icon AzureFunctionsTrigger theme aspect Color.</summary>
			...
			/// <summary>Loads the image for Themed Icon AzureFunctionsTrigger theme aspect Gray.</summary>
			...
			/// <summary>Loads the image for Themed Icon AzureFunctionsTrigger theme aspect GrayDark.</summary>
			...
			/// <summary>Returns the set of theme images for Themed Icon AzureFunctionsTrigger.</summary>
